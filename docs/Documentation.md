...
<p align="center">
  ...
  <a href="../README.md"><img src="https://img.shields.io/badge/version-1.23.1-blue.svg" alt="Version 1.23.1"></a>
</p>

> **Application version** : 1.23.1 (`CS.VERSION`)  
...
- **Version:** `CS.VERSION` = `1.23.1` ([`config-schema-core.js`](../assets/js/config-schema-core.js))
...
- The internal rate aims to keep about **55%** of the text (`rate: 0.55`). That rate is not exposed in the UI and is not persisted (no `pdm_*` key). README §5.4.2 documents the same facts with a short GIF (`readme-s542-token-compression.gif`) of the Input-side panel and Output result.
...
Example filename: `speech2texte-promptdemerde-profile-v1.23.1.zip`
...
| Key          | Type         | Role                      |
| ------------ | ------------ | ------------------------- |
| `version`    | string       | app semver e.g. `1.23.1`  |
...
*Technical documentation — application version 1.23.1.*
