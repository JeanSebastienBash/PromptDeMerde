 ...
 *
 * Synopsis : Décodage d'un fichier audio ou vidéo en PCM mono 16 kHz (100 % navigateur).
 * Objectif : Fournir decodeFile pour l'import média Workspace ; la piste audio d'une vidéo
 *            est extraite via AudioContext quand le navigateur sait la décoder.
 */
var SR = 16000;
...
export async function decodeFile(file) {
    ...
    try {
        ...
        try {
            ...
            var readErr = new Error('unsupported-media');
            readErr.cause = e;
            throw readErr;
        }
        var audio;
        try {
            ...
            var decErr = new Error('unsupported-media');
            decErr.cause = e;
            throw decErr;
        }
