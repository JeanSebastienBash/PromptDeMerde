...
<p align="center">
  ...
  <a href="docs/DOCUMENTATION-TECHNIQUE.md">Documentation avancée</a> ·
...
[Documentation avancée — import image](docs/DOCUMENTATION-TECHNIQUE.md#6bis-import-image--description) · [Notes de tag](.github/RELEASE_v1.23.0.md)
...
[Documentation avancée — présentation](docs/DOCUMENTATION-TECHNIQUE.md#1-présentation) · [Modèle de confidentialité](docs/DOCUMENTATION-TECHNIQUE.md#2-modèle-de-confidentialité)
...
[`SECURITY.md`](SECURITY.md) · [Documentation avancée — confidentialité](docs/DOCUMENTATION-TECHNIQUE.md#2-modèle-de-confidentialité)
...
[Documentation avancée — Workspace](docs/DOCUMENTATION-TECHNIQUE.md#32-workspace) · [Flux Ollama](docs/DOCUMENTATION-TECHNIQUE.md#4-ollama--flux-a-et-flux-b)
...
[Documentation avancée — prompts, système, prompts de contexte](docs/DOCUMENTATION-TECHNIQUE.md#5-prompts--système-prompts-de-contexte-générateurs)
...
[Documentation avancée — enregistrement WebM](docs/DOCUMENTATION-TECHNIQUE.md#64-enregistrement-webm)
...
[Documentation avancée — image → description](docs/DOCUMENTATION-TECHNIQUE.md#6bis-import-image--description)
...
[Documentation avancée — compresser les tokens](docs/DOCUMENTATION-TECHNIQUE.md#323-compresser-les-tokens)
...
[Documentation avancée — INPUT long multipass](docs/DOCUMENTATION-TECHNIQUE.md#321-input-long-multi-pass-inférence)
...
[Documentation avancée — paramètres LLM](docs/DOCUMENTATION-TECHNIQUE.md#43-paramètres-llm-workspace-panel)
...
[Documentation avancée — format d’affichage OUTPUT](docs/DOCUMENTATION-TECHNIQUE.md#322-format-daffichage-output)
...
[Documentation avancée — clés UI et brand](docs/DOCUMENTATION-TECHNIQUE.md#75-personnalisation-par-édition-zip)
...
[Documentation avancée — i18n](docs/DOCUMENTATION-TECHNIQUE.md#35-i18n)
...
[Documentation avancée — installation](docs/DOCUMENTATION-TECHNIQUE.md#10-installation-auto-hébergée) · [`SECURITY.md`](SECURITY.md)
...
[Documentation avancée — ZIP](docs/DOCUMENTATION-TECHNIQUE.md#7-export--import--archive-zip-profil)
...
[Documentation avancée — Ollama](docs/DOCUMENTATION-TECHNIQUE.md#4-ollama--flux-a-et-flux-b)
...
* En option : `PDM_ENV` pour le badge du footer ; le token proxy uniquement pour les opérateurs du relai officiel — voir [`SECURITY.md`](SECURITY.md).
...
[Documentation avancée — installation auto-hébergée](docs/DOCUMENTATION-TECHNIQUE.md#10-installation-auto-hébergée)
...
[`SECURITY.md`](SECURITY.md) · [Notes de déploiement](docs/DOCUMENTATION-TECHNIQUE.md#deploy-pdm-env-badges)
...
Composants tiers (liste complète dans [`THIRD_PARTY_NOTICES.md`](THIRD_PARTY_NOTICES.md)) :
...
Pour les signalements de sécurité, voir [`SECURITY.md`](SECURITY.md).
...
| Sujet | Document |
|-------|----------|
| Écrans, clés, ZIP, STT, architecture | [**Documentation utilisateur avancée**](docs/DOCUMENTATION-TECHNIQUE.md) |
| Contribuer | [`CONTRIBUTING.md`](CONTRIBUTING.md) |
| Sécurité et déploiement | [`SECURITY.md`](SECURITY.md) |
