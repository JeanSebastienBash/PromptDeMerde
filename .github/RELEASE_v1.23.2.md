...
- **Compression tokens** : les 4 cases (`compressInclude*`) vivent dans `pdm_workspace`, sont hydratées au restore, exportées dans le ZIP complet, remises à `false` en archive propre.
...
- [ ] Cocher 1–4 cases compression → F5 → cases cochées ; export/import ZIP → cases restaurées
